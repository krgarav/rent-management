...
export default function LoginPage() {
  ...
  const demoCredentials = [
    ...
    { role: 'Property Manager', email: 'manager@rentmanagement.com', password: 'manager123' },
    { role: 'Tenant', email: 'tenant@rentmanagement.com', password: 'tenant123' },
  ]
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-lg border border-border bg-card p-6 shadow-lg md:p-8">
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            Click any demo credential above to auto-fill the form, then click Sign In.
          </p>
        </div>
      </div>
    </main>
